    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "username":{
                	"regex":/^[0-9a-zA-Z_]{6,18}$/,
                	"alertText": "* 用户名为6-18位字母数字下划线的组合"
                },
                "password":{
                	"regex":/^[\@A-Za-z0-9\!\#\$\%\^\&\*\.\~]{6,18}$/,
                	"alertText": "* 请输入6-18位密码"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* 无效的 ",
                ...
                "url": {
                    ...
                    "alertText": "* 链接地址格式应形如http://mydomain.com"
                },
                "domain": {
                ...
                "ajaxCheckUserExists": {
                    "url": "userAction!ajaxRegisterCheck",
                ...
                "ajaxCheckDomainExists": {
                    "url": "userAction!ajaxRegisterCheck",
                    // you may want to pass extra data on the ajax call
                    "extraData": "name=eric",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "* 此域名可以注册",
                    "alertText": "* 此域名已被其他人注册",
                    "alertTextLoad": "* 正在确认帐号名称是否有其他人使用，请稍等。"
                },
                "ajaxCheckRandCode": {
                    "url": "userAction!ajaxRegisterCheck",
                    "alertText": "* 邀请码不正确或已过期",
                    "alertTextOk": "* 输入无误",
                    "alertTextLoad": "* 正在确认验证码请稍等。"
                },
