...
/////* Align the tables */
	...
	this.sHeaderHeight = 105;//this.sDataTable.tBodies[0].rows[(this.sDataTable.tHead) ? 0 : this.headerRows].offsetTop;//
	...
	if (this.fixedCols > 0) {		
		...
		sDataStyles += "width: " + (this.sParentWidth - this.sFHeaderWidth - 2) + "px;";
	} else {
		sDataStyles += "width: " + (this.sParentWidth-2) + "px;";
	}
