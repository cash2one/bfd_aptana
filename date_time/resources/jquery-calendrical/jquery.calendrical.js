...
//        '七月', '八月', '九月', '十月', '十一月', '十二月'];
        ...
        '7', '8', '9', '10', '11', '12'];   
//		var defaultDayNames="SMTWTFS"
       var defaultDayNames="日一二三四五六"
    function getToday()
    {
        var date = new Date();
...
//        }
        return date.getFullYear() + options.separator +s ; 
    }
...
//        }
    ...
    function renderCalendarHeader(element, year, month, options)
    {
        ...
        $('<th />').addClass('monthCell').attr('colSpan', 5).append(
            $('<a href="javascript:;">' +year  + '.' +
               monthNames[month] + '</a>').addClass('monthName')
        ).appendTo(titleRow);
        ...
        $.each(defaultDayNames.split(''), function(k, v) {
