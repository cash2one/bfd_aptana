/**
 * @fileoverview 这个文件是MD5加密类以及相关方法（API），Encrypt模块 
...
;(function(window) {
	 ...
	 * @class
	 * @constructor
	 * @namespace Encrypt命名空间
	 * @constructor
	 * @name Encrypt
	 * @private
	 * @memberOf BCore.encrypt
	 */
	...
	Encrypt.prototype = {
		...
		/*
		 * Convert a string to an array of little-endian words If this.chrsz is
	 ...
	 */
	BCore.encrypt = {};
	BCore.encrypt.Encrypt = new Encrypt();
})(window);