	...
	<div class="page">
		<div id="login-area">
			...
			<div class="la-box5">
				<h2>重设密码</h2>
				<div class="main">
					<form  id="form1" action="../../Account/user/!reSetPassword">
						<input type="hidden" name="user.passwordParam" value="${param.param }"/>
						<div class="item">
							<label class="tr">新密码</label>
							<span class="input-box"><input type="password" name="user.password" id="password" onselectstart="return false;" ondragenter="return false;" onpaste="return false;"/></span>
						</div>
						<div class="item">
							<label>再输一次</label>
							<span class="input-box"><input type="password" name="repassword" onselectstart="return false;" ondragenter="return false;" onpaste="return false;"/></span>
						</div>
