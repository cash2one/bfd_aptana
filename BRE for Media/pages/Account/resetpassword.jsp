...
<script type="text/javascript" src="../../js/regulateSize.js"></script>
    ...
    <script type="text/javascript" language="JavaScript" src="../../js/Account/resetpassword.js">
    </script>
             </head>
	...
	<div class="page">
		<div id="login-area">
			...
			<div class="la-box3">
				<h2>重设密码</h2>
				<div class="main">
					<form id="form1" action="/ifm/Account/user/!findPassword">
						<div class="item">
							<label>邮箱地址</label>
							<span class="input-box"><input type="text" id="username" name="username"/></span>
						</div>
						<div class="actions">
							<span class="btn"><input class="button" id="sub" type="button" value="提交"/></span>
						</div>
					</form>
				</div>
			</div>
