...
<script type="text/javascript" src="../../js/messageTip.js"></script>
	...
	<script type="text/javascript">
			$(function(){
				...
				$('#sitename').html('&nbsp;&gt;&nbsp;'+decodeURIComponent(request('sitename')))
			})
			new BaifendianWidgets({
		        pageId:'ifm_union_traffic_detail',
		        theme:'ifm',
...
<body>
	...
	<div class="main">
		...
		<ul class="nav2">
			...
			<li class="rbgno current"><a href="../../DataAnalysis/stat/!sourceshare.action">流量交换分析</a></li>
		</ul>
		...
		<div class="m-con">
			<div class="con-4">
				<div class="arrow"></div>
				<div class="title">
					<a href="../../DataAnalysis/stat/!sourceshare.action">流量交换分析</a>
					<span id="sitename" style="font-size:16px;"></span>
