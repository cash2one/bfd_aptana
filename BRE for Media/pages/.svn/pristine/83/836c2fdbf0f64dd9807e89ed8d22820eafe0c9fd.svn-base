...
<body>
	...
	<div class="content">
		<div class="main" style="height:500px;">
			<div class="m-top">&nbsp;</div>
			<div class="shoulu">
				<span class="leftimg"><img src="../../images/shoulugif.gif" alt="收录中"></span>
			  <p class="text">推豆儿正在努力收录您网站的文章~<br>请稍后<a href="../../ContentManager/content/!getCrawArticleState">刷新</a>此页面</p>
			</div>
		</div>
	</div>
	<!-- content   结束 -->
