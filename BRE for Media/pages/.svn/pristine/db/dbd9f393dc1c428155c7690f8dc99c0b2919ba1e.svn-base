...
<head>
	...
	<script type="text/javascript" src="../../js/SiteManager/site-selectplatform2.js"></script>
			...
			<div class="m-con mb300">
				<div class="con-5">
					<div class="add-site-c">
						<span class="top">当前站点：&nbsp;<strong><s:property value="site.address"/></strong></span>
						<div class="item">
							<label>建站平台：</label>
						...
						<p class="font-color">若需要手动安装代码，请选择“其他”选项</p>
						<div class="btn" style="display:none">
						 <form id="form1" autocomplete="off" action="../../SiteManager/site/!showInstallplug3" method="post">
