...
<head>
	...
	<script type="text/javascript" src="../../js/SiteManager/site-installplug.js"></script>
				...
				<div class="con-5">
					...
					<div class="add-site-c p-left55">
						<div class="tit">
							...
							<a id="modifySitePlatform" href="../../SiteManager/site/!showSelectPlatform"><span>[修改建站平台]</span></a>
						</div>
						<s:if test="sitePlatform.id == 1">
							<div class="step">
						       ...
						       <p class=" p-top"><span class="number">5.</span><span class="text">找到"推豆儿热文榜"和"推豆儿标签云"小工具，拖拽到<span style="background:#CCC">文章页</span>的边栏小工具区中（建站平台版本不同，名称略有不同）</span></p>
						...
						<s:elseif test="sitePlatform.id == 6">
							  <div class="step">
						        ...
						        <div class="pic"><img src="../../images/dede05.gif" class="ml30" /></div>
						         <p class=" p-top"><span class="number">8.</span><span class="text">将以下"标签云"和"热文榜"的代码粘贴到想要显示的位置，如粘贴在id="contentRtPicAD2"标签下方</span></p>
								<p class="p-con" style="padding-top:0;line-height:20px; height:60px; display: block; clear:both;"><span style="background: #3CF; ">{dede:include filename='bfd_ifm_cloud.htm'/}<br/>{dede:include filename='bfd_ifm_hot.htm'/}</span></p>
						...
						<div class="btn">
							...
							<a class="btn2" href="../../SiteManager/site/!showSelectPlatform"><span>上一步</span></a>
							<form id="form1" action="../../SiteManager/site/!showSelectPlatform" method="post">
