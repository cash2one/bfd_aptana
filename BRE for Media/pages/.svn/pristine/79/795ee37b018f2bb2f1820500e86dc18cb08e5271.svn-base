...
<script type="text/javascript"
	src="../../js/SiteManager/site-installcode.js"></script>
			...
			<div class="m-con border-top">
				<div class="con-5">
					<div class="add-site-tit3">
						<a href="#" class="set-btn1">验证网站</a> <a href="#" class="set-btn2">安装插件</a>
					</div>
					<div class="add-site-c p-left55">
						<div class="tit">
							<h3>代码安装教程</h3>
							<a id="modifySitePlatform"
								href="../../SiteManager/site/!showSelectPlatform"><span>[修改建站平台]</span>
							</a>
						</div>
						<div class="step">
							<%-- <p class="p-top">
							...
							<div class="ml30">
								<textarea class="txt"  readonly="readonly"><!--bfd_content_page-->
<div id="bfd_inner" class="bfd-widget"></div>
<div id="lepu_widget"></div>
<div id="bfd_flow" class="bfd-widget"></div> 
<div id="bfd-keyword"></div>
<script type="text/javascript" src="http://www.tuidouer.com/config/<s:property value="#session.sessionUser.address"/>/jsConfig.js"charset="utf-8"></script> 
<script type="text/javascript" src="http://www.tuidouer.com/plugin/tuidouer.js" charset="utf-8"></script>
								</textarea>
							</div>
							<div class="copy-btn">
							...
							<p class="p-top">
								<span class="number">1.</span><span class="text">复制以下代码，粘贴到每篇文章的正文结尾处，<span
									style="color: #F60">需要动态生成代码中的变量</span>
								</span>
							</p>
							<div class="ml30">
...
<script type="text/javascript" src="http://www.tuidouer.com/plugin/tuidouer.js" charset="utf-8"></script>
								...
								<div
									...
									id=&quot;bfd_flow&quot;
									class=&quot;bfd-widget&quot;&gt;&lt;/div&gt;为跨站流量交换推荐栏，可以根据您的需要粘贴到想要显示相关文章的位置</div>							</div>
							<div class="copy-btn">
								<a class="copy">复制代码</a> <span class="right" style="display:none;">复制成功</span>
							</div>
														<p class="p-top">
								<span class="number">2.</span><span class="text">请您输入带有JS代码页面进行验证，确保您的正常使用： </span>
							</p>
							<div class="ml30">
								<div style="font-size: 14px; line-height:20px;color:#444;">
							                        请您将  &lt;!--tuidouer_title_start--&gt;  和   &lt;!--tuidouer_title_end--&gt; 放置文章标题前后。
							        <br/>
							                        请您将  &lt;!--tuidouer_date--> 和   &lt;!--tuidouer_date--> 文章发布时间前后 
							        <br/>                
									例如：
									<div style="padding-left:32px;">
										&lt;h1&gt; <em style="color:#FF6600;">&lt;!--tuidouer_title_start--&gt;</em> 推豆儿是最好文章推荐工具 <em style="color:#FF6600;">&lt;!--tuidouer_title_end--&gt;</em> &lt;/h1&gt;
										<br/>
										&lt;span&gt;时间：<em style="color:#FF6600;">&lt;!--tuidouer_date_start--&gt;</em>2013-05-02 10:08<em style="color:#FF6600;">&lt;!--tuidouer_date_end--&gt;</em>&lt;/span&gt;
										<br/>
										&lt;span&gt;作者：小艾&lt;/span&gt;
										<br/>
										&lt;div class="arc"&gt;  
						...
						<%-- <div class="use">
							<h4>使用说明：</h4>
							<ul>
								<li>此段代码仅适用于<em><s:property value="#session.userSession.address" /></em>；</li>
						...
						<div class="btn">
							...
							<a class="btn2" href="../../SiteManager/site/!showSelectPlatform">
							  <span>上一步</span>
							</a>
							<%--
							<form id="form1"
								action="../../SiteManager/site/!showSelectPlatform"
								method="post">
