		...
		<div class="main">
			...
			<div class="m-con pt17">
				...
				<div class="area">
					<span>&nbsp;</span>
					<span>&nbsp;</span>
					<span class="margin-right0">&nbsp;</span>
				</div>
				<div class="stop">
					<p class="stop-text">用户停用提示：您已停用流量交换功能，将无法获取其他网站流量。 <a href="#" class="reset">【重新开启流量交换】</a></p>
					<p class="stop-text">运营人员停用提示：检测到您的网站出现异常，您暂时不能使用流量交换功能，如有疑问，请联系yunwei@tuidouer.com。</p>
				</div>
			</div>
		</div>
	</div>
