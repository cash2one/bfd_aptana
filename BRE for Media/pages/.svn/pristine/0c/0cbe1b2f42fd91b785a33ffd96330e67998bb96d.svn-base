...
<head>
	...
	<script type="text/javascript" src="../../js/SiteManager/site-installplug3.js"></script>
				...
				<div class="con-5">
					<div class="add-site-c p-left55">
						<div class="tit">
							...
							<a id="modifySitePlatform" href="../../SiteManager/site/!showSelectPlatform3"><span>[修改建站平台]</span></a>
						</div>
...
<%-- 						<div class="step">
						...
						<div class="btn">
							...
							<a class="btn2" href="../../SiteManager/site/!showSelectPlatform3"><span>上一步</span></a>
							<form id="form1" action="../../SiteManager/site/!checkingJS3" method="post">
								<input type="hidden" name="address" id="address2" value="site.address"/>
							</form>
						</div>
					</div>
				</div>
